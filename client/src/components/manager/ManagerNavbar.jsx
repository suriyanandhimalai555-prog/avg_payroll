...
const ManagerNavbar = ({ toggleMobileSidebar, toggleDesktopSidebar, isDesktopCollapsed }) => {
    return (
        <header className="h-20 bg-white border-b border-slate-200 shadow-sm flex items-center justify-between px-4 md:px-6 shrink-0 z-10 w-full transition-all duration-300">
            ...
            <div className="flex items-center gap-4 md:gap-6 flex-1">
                ...
                <div className="relative w-full max-w-md hidden md:block">
                    ...
                    <input
                        type="text"
                        placeholder="Search team, leave requests, timesheets..."
            ...
            <div className="flex items-center gap-4 md:gap-6">
                ...
                <div className="flex items-center gap-3 md:pl-4 md:border-l border-slate-200 cursor-pointer group">
                    <div className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-indigo-600/20 p-0.5 group-hover:border-indigo-600 transition-all bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold text-sm">
                        MG
                    </div>
                    <div className="hidden sm:block">
                        <p className="text-sm font-bold text-[#010a1f]">Manager</p>
