...
import {
    FaUsers, FaUserCheck, FaUserPlus, FaPlaneDeparture,
    FaRegClock, FaMoneyCheckAlt, FaFileSignature, FaChartPie, FaSearch, FaFileAlt
} from 'react-icons/fa';
...
const HRDashboardCom = () => {
    ...
    const topCards = [
        { title: 'Total Employees', value: '450', icon: FaUsers, color: 'text-[#0437cc]', bg: 'bg-[#0437cc]/10', border: 'border-l-[#0437cc]' },
        { title: 'Active Employees', value: '428', icon: FaUserCheck, color: 'text-green-600', bg: 'bg-green-100', border: 'border-l-green-500' },
        { title: 'New Joiners', value: '24', icon: FaUserPlus, color: 'text-indigo-600', bg: 'bg-indigo-100', border: 'border-l-indigo-500' },
        { title: 'Pending Leave', value: '18', icon: FaPlaneDeparture, color: 'text-[#f77704]', bg: 'bg-[#f77704]/10', border: 'border-l-[#f77704]' },
        { title: 'Attendance Fixes', value: '8', icon: FaRegClock, color: 'text-[#010a1f]', bg: 'bg-[#010a1f]/10', border: 'border-l-[#010a1f]' },
        { title: 'Pending Payroll', value: '1', icon: FaMoneyCheckAlt, color: 'text-red-600', bg: 'bg-red-100', border: 'border-l-red-500' },
    ];

    const pendingActions = [
        { label: 'Leave Requests (12)', icon: FaPlaneDeparture, action: '#' },
        { label: 'Attendance Fixes (8)', icon: FaRegClock, action: '#' },
        { label: 'Employee Docs (5)', icon: FaFileSignature, action: '#' },
        { label: 'Payroll Approval (1)', icon: FaMoneyCheckAlt, action: '#' },
    ];
    ...
    return (
        <div className="space-y-8 pb-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <div>
                    <h1 className="text-2xl font-bold text-[#010a1f] tracking-tight">HR Dashboard Overview</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    ...
                    {/* Pending Actions Panel utilizing Common Button */}
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                        <h2 className="text-base font-bold text-[#010a1f] mb-5 border-b border-slate-100 pb-3">Pending Actions</h2>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="pt-4 border-t border-slate-100">
                                <ToggleSwitch
                                    label="System Alerts"
                                    description="Receive real-time HR notifications"
